...
export const PROFILE_ROUTES = '/profile/routes';

export const NOTIF_NOTIFICATIONS = '/notif/notifications';
export const NOTIF_MESSAGES = '/notif/messages';
...
export const LANDINGSPAGE = '/landingspage';
